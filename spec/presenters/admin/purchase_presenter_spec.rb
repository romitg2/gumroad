  ...
  describe "#props" do
    ...
    describe "database attributes" do
      ...
      context "when purchase has a subscription" do
        ...
        it "returns subscription with nil timestamps when not cancelled" do
        ...
        context "when subscription is cancelled" do
          let(:cancellation_time) { 2.days.ago }
          ...
          it "returns subscription with cancellation timestamps" do
            expect(props[:subscription]).to match(
              id: subscription.id,
              external_id: subscription.external_id,
              ...
              ended_at: nil,
              failed_at: nil,
              subscription_end_date: be_within(1.second).of(end_time),
            )
          end
        end
      end
